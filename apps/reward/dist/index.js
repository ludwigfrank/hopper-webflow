(function(f) {
  ...
  */
  ...
  const animateCardIn = (element) => {
    gsapWithCSS.set(element, { opacity: 1, display: "block" });
    gsapWithCSS.fromTo(
      element,
      {
        scale: 0.2,
  ...
  function rewardAnimation() {
    ...
    const $rewardView = document.querySelector(".reward-view");
    document.querySelector("body");
    const $rewardItems = document.querySelectorAll(
      "[data-component]"
    );
    if (!$rewardView)
      throw Error("No reward view element found");
